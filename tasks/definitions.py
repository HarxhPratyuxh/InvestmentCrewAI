...
get_company_financials = Task(
    description="Get financial data like income statements, fundamental ratios, and technical indicators (RSI, Moving Averages) for stock: {stock}",
    expected_output="Detailed information from income statement, key ratios, and technical analysis indicators for {stock}. "
